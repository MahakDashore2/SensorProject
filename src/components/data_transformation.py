...
#         self.utils = MainUtils() # to save the object
...
#             X = dataframe.drop(columns=TARGET_COLUMN)
#             y = np.where(dataframe[TARGET_COLUMN] == -1,0,1)
# #             Look at the column in the DataFrame named by TARGET_COLUMN.
#             # For every row in that column:

#             # If the value is -1, convert it to 0

#             # Otherwise, convert it to 1

#             # Store the result in a new NumPy array called y
